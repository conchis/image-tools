...
class Transform:
   """
   An affine transformation matrix for translating from one coordinate system to another.
      
   self.matrix - 3 x 3 transformation matrix stored as a list of nine values.
   """
