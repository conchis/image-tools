...
package origami.viewer
{
	...
	public class ImageViewer extends Viewer
	{
		...
		override protected function createChildren(): void
		{
			...
			tiled_image.addEventListener(IOErrorEvent.IO_ERROR, onIOError);
			...
			rollover.addEventListener(IOErrorEvent.IO_ERROR, onIOError);
		...
		public function set image_url(image_url: String): void
		{
			...
			image_model.addEventListener(IOErrorEvent.IO_ERROR, onIOError);
		}
