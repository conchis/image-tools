...
package origami.viewer
{
	...
	public class Navigator extends Canvas
	{
		...
		override protected function createChildren():void
		{
			...
			thumbnail.addEventListener(IOErrorEvent.IO_ERROR, onIOError);
			thumbnail.x = 8;
			thumbnail.y = 60;
			addChild(thumbnail);
		...
		/**
		 * Detaches the zoom mode button.
		 * 
		 * @return The zoom mode button.
		 */
		 
		public function detachZoomModeButton ():Button
		{
			removeChild(zoom_mode_button);
			return zoom_mode_button;
		}
		
		/**
		 * Detaches the pan mode button.
		 * 
		 * @return The pan mode button.
		 */
		 
		public function detachPanModeButton ():Button
		{
			removeChild(pan_mode_button);
			return pan_mode_button;
		}
		...
		/**
		 * Sets the mode to "no mode".
		 */
		 
		public function setNoMode(): void
		{
			__viewer_model.mode = ViewerModel.NO_MODE;
		}
		...
		public function setToolTips (
			...
			zoomInTip: String,
			zoomOutTip: String,
			zoomSliderTip: String,
			resetTip: String): void
		{
			thumbnail.toolTip = thumbnailTip;
			zoom_mode_button.toolTip = zoomModeTip;
			pan_mode_button.toolTip = panModeTip;
			rotation_wheel.setToolTips(rotWheelTip, rotLeftTip, rotRightTip);
			zoom_in_button.toolTip = zoomInTip;
			zoom_out_button.toolTip = zoomOutTip;
			zoom_slider.toolTip = zoomSliderTip;
			reset_button.toolTip = resetTip;
		}
