...
package origami.expressions
{
    ...
    /**
     * An Expression is a wrapper for an expression function that maintains
    ...
    public class Expression
    {
        ...
        /**
         * Constructs an expression by compiling the expression text.
         *
        ...
        public function Expression(expression: String)
        {
            ...
            __function = compiler.compileExpression(expression);
        }
