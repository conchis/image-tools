...
package origami.page_dial
{
	...
	public class PageDial extends Component
	{
	    ...
	    /** Interval view. */
	    private var intervals: IntervalRuler;

		/** Ruler view. */
		private var ruler: PageDialRuler;
		...
		override protected function createChildren():void
		{
			...
			intervals = new IntervalRuler();
			intervals.x = MARK_LEFT;
			intervals.y = ruler_top;
			//intervals.width = 600;
			intervals.percentWidth = 90;
			intervals.height = 36;
			addChild(intervals);

			ruler = new PageDialRuler();
			ruler.x = MARK_LEFT;
			ruler.y = ruler_top + 30;
			//ruler.width = 600;
