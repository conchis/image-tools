...
package origami.viewer
{
	...
	public class Thumbnail extends UIComponent
	{
		...
		public static const LINE_COLOR: int = 0xFF0000;
		...
		private var naviagtor_transform: Transform;
		...
		private function onImageLoaded(event: Event): void
		{
			...
			setActualSize(thumbnail.width, thumbnail.height);
		...
		private function updateTransforms(): void
		{
			...
			naviagtor_transform = Transform.makeScale(scale, scale);
			scene_transform = naviagtor_transform.inverse();
		}
		...
		override protected function updateDisplayList(width: Number, height: Number): void
		{
			...
			if (viewport == null || __thumbnail_url == null || selection_canvas == null
				|| naviagtor_transform == null) return;

			var graphics: Graphics = selection_canvas.graphics;
			graphics.clear();
			var view_polygon: Polygon = viewport.clipped_view_polygon.project(naviagtor_transform);
