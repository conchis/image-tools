...
package origami.viewer
{
	...
	public class Viewer extends Component
	{
		...
		private function updateMode(shift_key: Boolean, alt_key: Boolean, contrtol_key: Boolean): void
		{
			if (__viewer_model.isTemporaryMode())
				updateTemporaryMode(shift_key, alt_key, contrtol_key);
			else
				updatePermenentMode(shift_key, alt_key, contrtol_key);
		}
		...
		/**
		 * Calls stepAnimation on the viewport to animate zoom and pans.
		 *
